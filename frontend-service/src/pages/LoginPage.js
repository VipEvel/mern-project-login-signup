...
const LoginSignup = (props) => {
  ...
  return (
    ...
    >
      {(formikOptions) => {
        const { isSubmitting, errors, touched, values, dirty, isValid } =
          formikOptions;
                            ...
                            <div className="section text-center">
                              ...
                              <div className="form-group flex mt-2">
                                <Field
                                  type="text"
                                  name="dob"
                                  className={`px-5 py-3 outline-none w-full rounded-l-md ${
                                ...
                                <Field
                                  type="date"
                                  name="dob"
                                  className={`py-[10px] outline-none pr-[10px] w-[32px] rounded-r-md ${
                                    errors.dob && touched.dob ? "error" : ""
                                  }`}
                                />
                              </div>
